...
public class EndElement extends Element {
    ...
    public void draw(Graphics g) {
        ImageIcon i;
        if (getZoom() == 60) i = new ImageIcon(getClass().getResource("/designer/resources/End50.png"));
        else if (getZoom() == 80) i = new ImageIcon(getClass().getResource("/designer/resources/End50.png"));
        else i = new ImageIcon(getClass().getResource("/designer/resources/End50.png"));
